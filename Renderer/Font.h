...
#define CHARSET_BALTIC			0
#define CHARSET_CHINESE_TRAD	0
#define CHARSET_DEFAULT			0
#define CHARSET_EASTEUR			0
#define CHARSET_CHINESE_SIMPLE	0
#define CHARSET_GREEK			0
#define CHARSET_HANGUL_KOREAN	0
#define CHARSET_APPLE			0
#define CHARSET_OEM				0
#define CHARSET_CYRILLIC		0
#define CHARSET_JAPANESE		0
#define CHARSET_SYMBOL			0
#define CHARSET_TURKISH			0
#define CHARSET_VIETNAMESE		0
