...
#pragma once
#ifndef __MYLLY_GUI_DIRECTX8_RENDERER_H
#define __MYLLY_GUI_DIRECTX8_RENDERER_H
...
private:
	...
	static IDirect3DTexture8*		renderTexture;	// Current texture
	static IDirect3DVertexBuffer8*	vertexBuffer;	// Pointer to vertex buffer
	static IDirect3DVertexBuffer8*	vertexBuffer3d;	// Pointer to 3D vertex buffer
	...
	static DWORD					normState;		// Norm state
	static DWORD					drawState;		// Draw state
	static DWORD					drawState3d;	// Draw state for 3D mode
	...
	static D3DVIEWPORT8				viewport;		// Default viewport
...
#endif /* __MYLLY_GUI_DIRECTX8_RENDERER_H */
